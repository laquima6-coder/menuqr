...
function LoginModal({ onSuccess, onClose }) {
  ...
  const S = {
    ...
    btn:     { width:"100%",padding:13,background:"#14B8A6",border:"none",borderRadius:8,color:"#0D0804",fontSize:"1rem",fontWeight:800,cursor:"pointer",fontFamily:"'DM Sans',sans-serif" },
  ...
  return (
    <div style={{maxWidth:430,margin:"0 auto",minHeight:"100vh",background:"#060810",
      ...
      <div style={{textAlign:"center",marginBottom:44,animation:"fadeUp .6s ease both"}}>
        ...
        <p style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:10,color:"#14B8A6",
      ...
      <div style={{width:"100%",display:"flex",flexDirection:"column",gap:12,
        ...
        {[
          {mode:"client",icon:"📱",title:"Vista del Cliente",
           ...
           accent:"#14B8A6",bg:"linear-gradient(135deg,#1A140A,#241A0E)"},
...
function HappyHourBanner({happyHasta, happyHour, lang}) {
  ...
  return (
    <div style={{background:"linear-gradient(90deg,#1A0D00,#120900)",borderBottom:"1px solid rgba(201,168,76,.15)",padding:"7px 10px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      <div style={{fontFamily:"'DM Sans',sans-serif",fontSize:10,color:"#14B8A6",fontWeight:600}}>Happy Hour · hasta {happyHasta}hs</div>
      <span style={{fontFamily:"monospace",fontSize:14,fontWeight:900,color:"#14B8A6",letterSpacing:2}}>{fmt(secs)}</span>
    </div>
  );
}
        ...
        <div style={{background:"linear-gradient(135deg,rgba(201,168,76,.15),rgba(201,168,76,.05))",
          ...
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:promoActivada?0:12}}>
            ...
            <div>
              <div style={{fontFamily:"'Outfit',sans-serif",fontWeight:800,fontSize:14,
                color:promoActivada?"#00CC70":"#14B8A6",lineHeight:1.1}}>
          ...
          {!promoActivada && (
            <button onClick={activarPromo} style={{
              width:"100%",background:"linear-gradient(135deg,#14B8A6,#E8C97A)",
    ...
    <div style={{background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.08)",
      ...
      <div style={{display:"flex",gap:10,marginBottom:10}}>
        ...
        <div style={{flex:1,background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.08)",
          borderRadius:10,padding:"10px 12px",textAlign:"center"}}>
          <div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:24,fontWeight:700,
            color:"#14B8A6",lineHeight:1}}>{pct}%</div>
            ...
            return (
              <div key={d.k} style={{display:"flex",alignItems:"center",gap:8,padding:"5px 0",
                ...
                <span style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:11,fontWeight:700,
                  color:esHoy?"#14B8A6":"#5A5A5A",width:28,flexShrink:0}}>{d.n}</span>
                {dia.abierto
                ...
                {esHoy && <span style={{marginLeft:"auto",fontFamily:"'IBM Plex Mono',monospace",fontSize:8,color:"#14B8A6",letterSpacing:1}}>HOY</span>}
              </div>
            );
          })}
        </div>
...
function ClientApp({onBack, local, cats, prods, vitrina=false, sinPedidos=false}) {
  ...
  if(view==="done"&&pcMode){
          ...
          <div style={{width:"100%",maxWidth:500}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:32}}>
              {STEPS2.map((s,i)=>{
                ...
                return(
                  <div key={s.key} style={{display:"flex",alignItems:"center",gap:14,padding:"12px 16px",borderRadius:12,border:`1px solid ${active?"#4A9A5A44":done?"#14B8A633":warmBorder}`,background:active?"#4A9A5A0A":done?"#14B8A60A":creamBg,transition:".3s"}}>
    ...
    const acColor = local.color||"#14B8A6";
  ...
  if(view==="cart"&&pcMode){
      ...
      <div style={{display:"flex",height:"100vh",overflow:"hidden",fontFamily:"Georgia,serif"}}>
        ...
        {/* Propina */}
            ...
            {(pay==="mp"||pay==="trans") && local.mp_mostrar_alias && local.mp_alias && (
              <div style={{marginBottom:20,background:"#FFF8EC",border:"1px solid #14B8A666",borderRadius:14,padding:"16px 18px"}}>
                ...
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,marginBottom:10}}>
                  ...
                  <button onClick={()=>{navigator.clipboard.writeText(local.mp_alias);}} className="pr"
                    style={{background:"#14B8A6",border:"none",borderRadius:8,padding:"8px 14px",fontFamily:"'IBM Plex Mono',monospace",fontSize:12,fontWeight:700,color:"#1C1008",cursor:"pointer",whiteSpace:"nowrap"}}>
                    📋 Copiar alias
                  </button>
                </div>
                {local.whatsapp&&(
    ...
    <div style={{maxWidth:430,margin:"0 auto",minHeight:"100vh",background:"#F6F6F6",paddingBottom:120,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{background:"#FFF",padding:"16px 16px 14px",borderBottom:"1px solid #EBEBEB",display:"flex",alignItems:"center",gap:14,position:"sticky",top:0,zIndex:20,boxShadow:"0 1px 8px rgba(0,0,0,.06)"}}>
        ...
        <div style={{fontFamily:"'Outfit',sans-serif",fontSize:16,fontWeight:800,color:local.color||"#14B8A6"}}>$ {fmt(grandTotal)}</div>
      </div>
      ...
      <div style={{padding:"12px 14px"}}>
        ...
        <div style={{background:"#FFF",borderRadius:16,overflow:"hidden",marginBottom:12,border:"1px solid #EBEBEB"}}>
          {items.map((item,i)=>(
            <div key={item.id} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 14px",borderBottom:i<items.length-1?"1px solid #F5F5F5":"none"}}>
              ...
              {item.foto_url?(
                ...
                <div style={{width:54,height:54,borderRadius:10,background:(local.color||"#14B8A6")+"15",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,flexShrink:0}}>{item.emoji||"🍽️"}</div>
              )}
              <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6,flexShrink:0}}>
                <div style={{fontFamily:"'Outfit',sans-serif",fontSize:14,fontWeight:800,color:local.color||"#14B8A6"}}>$ {fmt(item.price*item.qty)}</div>
                <div style={{display:"flex",alignItems:"center",gap:5}}>
                  ...
                  <button onClick={()=>add(item)} className="pr" style={{width:26,height:26,borderRadius:7,background:local.color||"#14B8A6",border:"none",color:"#fff",fontSize:15,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",lineHeight:1}}>+</button>
                </div>
              </div>
            </div>
          ))}
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"12px 16px",background:"#FAFAFA",borderTop:"1px solid #EBEBEB"}}>
            ...
            <span style={{fontFamily:"'Outfit',sans-serif",fontSize:18,fontWeight:800,color:local.color||"#14B8A6"}}>$ {fmt(subTotal)}</span>
          </div>
        </div>
          ...
          <div style={{background:"#FFF",borderRadius:14,padding:"14px 16px",marginBottom:12,border:"1px solid #EBEBEB"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8}}>
              {[{label:"No",val:0},{label:"10%",val:10},{label:"15%",val:15},{label:"20%",val:20}].map(t=>(
                <button key={t.val} onClick={()=>{setTipPct(t.val);setTC("");}} className="pr" style={{background:tipPct===t.val?(local.color||"#14B8A6"):"#F5F5F5",border:"none",borderRadius:10,padding:"10px 4px",cursor:"pointer",textAlign:"center",transition:".15s"}}>
          ...
          {pay==="mixto"&&(
            <div style={{background:"#F8F8F8",borderRadius:12,padding:"14px",marginTop:4,border:"1px solid #EBEBEB"}}>
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12,padding:"8px 10px",background:"#FFF",borderRadius:8,border:"1px solid #E8E8E8"}}>
                ...
                <span style={{fontFamily:"'Outfit',sans-serif",fontSize:15,fontWeight:800,color:local.color||"#14B8A6"}}>$ {fmt(grandTotal)}</span>
              </div>
              {/* Método 1 */}
              ...
              {mixto1&&mixto2&&(
                <button onClick={()=>{const h=Math.ceil(grandTotal/2);setSplitAmt(String(h));setSplitAmt2(String(grandTotal-h));}}
                  style={{background:"none",border:`1.5px solid ${local.color||"#14B8A6"}`,borderRadius:8,padding:"6px 14px",color:local.color||"#14B8A6",fontSize:12,fontWeight:800,cursor:"pointer"}}>
                  ÷ 50/50
                </button>
              )}
            </div>
        ...
        {(pay==="mp"||pay==="trans"||(pay==="mixto"&&(mixto1==="mp"||mixto1==="trans"||mixto2==="mp"||mixto2==="trans")))&&local.mp_mostrar_alias&&local.mp_alias&&(
          <div style={{background:"#FFFBEB",border:"1px solid #FDE68A",borderRadius:14,padding:"14px 16px",marginBottom:12}}>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,marginBottom:local.whatsapp?10:0}}>
              ...
              <button onClick={()=>navigator.clipboard.writeText(local.mp_alias)} className="pr"
                style={{background:local.color||"#14B8A6",border:"none",borderRadius:9,padding:"8px 14px",fontFamily:"'IBM Plex Mono',monospace",fontSize:11,fontWeight:700,color:"#fff",cursor:"pointer",whiteSpace:"nowrap"}}>
                📋 Copiar
              </button>
            </div>
            {local.whatsapp&&(
            ...
            {showDividir&&(
              <div style={{padding:"0 16px 14px",borderTop:"1px solid #F0F0F0"}}>
                <div style={{display:"flex",alignItems:"center",gap:12,margin:"10px 0"}}>
                  ...
                  <span style={{fontFamily:"'Outfit',sans-serif",fontSize:20,fontWeight:800,color:local.color||"#14B8A6",flex:1,textAlign:"center"}}>{dividirN} personas</span>
                ...
                <div style={{background:"#F8F8F8",borderRadius:10,padding:"10px 14px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  ...
                  <span style={{fontFamily:"'Outfit',sans-serif",fontSize:18,fontWeight:800,color:local.color||"#14B8A6"}}>$ {fmt(Math.ceil(grandTotal/dividirN))}</span>
                </div>
              </div>
            )}
          </div>
      ...
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,padding:"12px 16px 28px",background:"linear-gradient(transparent,#F6F6F6 28%)"}}>
        {(pay&&(pay!=="mixto"||(mixto1&&mixto2)))&&(
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 16px",background:"#FFF",border:"1px solid #EBEBEB",borderRadius:14,marginBottom:10,boxShadow:"0 2px 8px rgba(0,0,0,.06)"}}>
            <div>
              ...
              <div style={{fontFamily:"'Outfit',sans-serif",fontSize:18,fontWeight:800,color:local.color||"#14B8A6"}}>$ {fmt(grandTotal)}</div>
            </div>
        ...
        <button onClick={async()=>{
          ...
          width:"100%",
          background:(pay&&(pay!=="mixto"||(mixto1&&mixto2)))?(local.color||"#14B8A6"):"#E0E0E0",
                      ...
                      return(
                        <div key={item.id} style={{background:inCart>0?"#EDE4CE":"#EEE8D8",border:`1px solid ${inCart>0?ac+"88":warmBorder}`,borderRadius:10,display:"flex",gap:12,alignItems:"center",padding:"12px 14px",transition:".2s",cursor:"pointer"}}
                          ...
                          <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6,flexShrink:0}}>
                            ...
                            {item.tag&&<span style={{fontFamily:"'DM Sans',sans-serif",fontSize:8,fontWeight:700,padding:"2px 6px",borderRadius:4,background:item.tag==="CHEF"?"#14B8A622":"#4A9A5A22",color:item.tag==="CHEF"?"#8A6A30":"#4A7A50",border:`1px solid ${item.tag==="CHEF"?"#14B8A655":"#4A9A5A44"}`}}>{item.tag}</span>}
                            {item.sin_stock?(
    ...
    <div style={{maxWidth:430,margin:"0 auto",minHeight:"100vh",background:"#F6F6F6",display:"flex",flexDirection:"column",position:"relative",fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{position:"sticky",top:0,zIndex:30,background:"#FFF",borderBottom:"1px solid #EBEBEB",boxShadow:"0 1px 8px rgba(0,0,0,.06)"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:12,padding:"14px 16px 10px"}}>
          {local.logo_url?(
            ...
            <div style={{width:44,height:44,borderRadius:12,background:local.color||"#14B8A6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>{local.emoji||"🍽️"}</div>
          )}
          <div style={{flex:1,minWidth:0}}>
            ...
            {local.mesa?<div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:10,fontWeight:700,color:local.color||"#14B8A6",marginTop:2}}>Mesa {local.mesa}</div>:null}
          </div>
          {!effectiveVitrina&&cartCount>0&&(
            <button onClick={()=>setView("cart")} style={{flexShrink:0,background:local.color||"#14B8A6",border:"none",borderRadius:22,padding:"8px 14px",cursor:"pointer",display:"flex",alignItems:"center",gap:6}}>
        ...
        <div style={{display:"flex",gap:8,padding:"0 14px 12px",overflowX:"auto",scrollbarWidth:"none",WebkitOverflowScrolling:"touch"}}>
          {[{id:"TODO",icon:"",label:lang==="en"?"All":lang==="pt"?"Tudo":lang==="fr"?"Tout":lang==="de"?"Alle":lang==="it"?"Tutto":lang==="zh"?"全部":lang==="ja"?"全て":lang==="ko"?"전체":lang==="gn"?"Mba'etéva":"Todo"},...activeCats].map(cat=>(
            <button key={cat.id} onClick={()=>setAC(cat.id)} className="pr" style={{
              ...
              background:activeCat===cat.id?(local.color||"#14B8A6"):"#F0F0F0",
      ...
      {!effectiveVitrina&&cartCount>0&&(
        <div style={{position:"fixed",bottom:24,left:"50%",transform:"translateX(-50%)",zIndex:40,width:"calc(100% - 32px)",maxWidth:398}}>
          <button onClick={()=>setView("cart")} className="pr" style={{width:"100%",background:local.color||"#14B8A6",border:"none",borderRadius:16,padding:"15px 20px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",boxShadow:"0 8px 28px rgba(0,0,0,.25)",transition:"all .2s"}}>
...
function QRTabComp({ mesaNum, setMesaNum, qrType, setQrType, promoUrl, setPromoUrl, local }) {
  ...
  const QR_TYPES = [
    {id:"mesa",     icon:"🪑", label:"Mesa",      desc:"Un QR único por mesa",               color:"#14B8A6"},
    {id:"vitrina",  icon:"🪟", label:"Vitrina",   desc:"Carta en la puerta / vidrio",        color:"#14B8A6"},
    {id:"cocina",   icon:"👨‍🍳", label:"Cocina",    desc:"Pantalla de pedidos en cocina",      color:"#14B8A6"},
    {id:"wifi",     icon:"📶", label:"WiFi",      desc:"Conectarse al escanear",             color:"#14B8A6"},
    {id:"whatsapp", icon:"💬", label:"WhatsApp",  desc:"Pedidos por WA — flujo completo",    color:"#14B8A6"},
    {id:"promo",    icon:"🔥", label:"Promo",     desc:"URL personalizada de promo",         color:"#14B8A6"},
  ];
    ...
    <div>
      ...
      <div style={{background:"var(--gc)",border:"1px solid var(--gbr)",
        ...
        <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14}}>
          <input type="color" value={local.color||"#14B8A6"}
          ...
          <div style={{flex:1,background:"var(--gb)",border:"1px solid var(--gbr)",
            borderRadius:10,padding:"11px 14px",color:"var(--gbri)",fontSize:14,
            fontFamily:"'IBM Plex Mono',monospace"}}>{local.color||"#14B8A6"}</div>
          <div style={{width:42,height:42,borderRadius:10,
            background:local.color||"#14B8A6",border:"1px solid var(--gbr)",flexShrink:0}}/>
        </div>
    ...
    <div style={{background:"var(--ac)",border:"1px solid var(--abr)",borderRadius:16,padding:18,marginBottom:12}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:16}}>
        ...
        <div style={{flex:1,background:"var(--as)",border:"1px solid var(--abr)",borderRadius:10,
          padding:"11px 14px",color:"var(--abri)",fontSize:14,fontFamily:"'IBM Plex Mono',monospace"}}>{local.color||"#14B8A6"}</div>
        <div style={{width:42,height:42,borderRadius:10,background:local.color||"#14B8A6",border:"1px solid var(--abr)",flexShrink:0}}/>
      </div>
      ...
      <AdminModal onClose={onClose}>
        <div style={{padding:"16px 20px 28px",textAlign:"center"}}>
          ...
          <div style={{display:"inline-block",background:"#F5ECD7",borderRadius:20,
            padding:"20px 24px",marginBottom:16,border:"2px solid #14B8A6",
            boxShadow:"0 8px 40px rgba(0,0,0,.4)"}}>
            <p style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:9,
              color:"#14B8A6",letterSpacing:3,textTransform:"uppercase",marginBottom:6}}>
              {local.nombre}
            </p>
            <div style={{width:32,height:2,background:"#14B8A6",margin:"0 auto 12px",borderRadius:1}}/>
            <div style={{background:"#fff",borderRadius:12,padding:8,
              border:"3px solid #14B8A6",display:"inline-block"}}>
              <QRImage data={data} size={160}/>
            </div>
            <div style={{background:"#14B8A6",borderRadius:30,padding:"6px 24px",
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .card{text-align:center;padding:48px 60px;border:3px solid #14B8A6;border-radius:28px;background:#fff}
  .name{font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#14B8A6;margin-bottom:18px;font-family:monospace}
  .qr{background:#fff;border:3px solid #14B8A6;border-radius:14px;padding:12px;display:inline-block;margin-bottom:18px}
  .label{background:#14B8A6;color:#0A0806;border-radius:30px;padding:9px 32px;display:inline-block;font-size:17px;font-weight:700;margin-bottom:12px;font-family:sans-serif}
  .url{font-size:9px;color:#999;word-break:break-all;max-width:260px;margin:0 auto;font-family:monospace}
</style></head><body>
<div class="card">
  <div class="name">${local.nombre||"MenuQR"}</div>
...
<script>window.onload=function(){window.print();setTimeout(function(){window.close()},1500)}</script>
  ...
  ══════════════════════════════════════════ */
  const TABS = [
    {id:"home",      icon:"◈", label:"Inicio",    color:"#14B8A6"},
    {id:"orders",    icon:"⊞", label:"Pedidos",   color:"#14B8A6", badge:newCount+solicitudes.length},
    {id:"carta",     icon:"≡", label:"Carta",     color:"#14B8A6"},
    {id:"qr",        icon:"⬛", label:"QRs",       color:"#14B8A6"},
    {id:"caja",      icon:"◉", label:"Caja",      color:"#14B8A6"},
    {id:"mostrador", icon:"🏪", label:"Mostrador", color:"#14B8A6"},
    {id:"cocina",    icon:"👨‍🍳", label:"Cocina",   color:"#14B8A6"},
    {id:"reportes",  icon:"📊", label:"Reportes",  color:"#14B8A6"},
    {id:"gestion",   icon:"✏", label:"Gestión",   color:"#14B8A6"},
    {id:"config",    icon:"⚙", label:"Config",    color:"#14B8A6"},
...
export default function MenuQR({
  ...
  async function loadRestaurantData(userId) {
    ...
    try {
      ...
      setLocal({
        ...
        email: rest.email || "", color: rest.color || "#14B8A6",
  ...
  if (authLoading) return (
    <div style={{background:"#060810",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center"}}>
      <GS/>
      <div style={{width:40,height:40,border:"3px solid #1A2230",borderTopColor:"#14B8A6",borderRadius:"50%",animation:"spin .8s linear infinite"}}/>
    </div>
  );
